...
const OpportunityDetailsTable: React.FC<OpportunityDetailsTableProps> = ({ context, customers = [],startDate, endDate }) => {
  ...
  useEffect(() => {
    async function fetchData() {
      const list = sp.web.lists.getByTitle("CWSalesRecords").items.select(
        "Customer", "OpportunityID", "OppAmount", "OpportunityStatus",
        "TentativeStartDate", "TentativeDecisionDate", "ReportDate", "Title"
      );
