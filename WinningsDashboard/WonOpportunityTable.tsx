...
interface WonOpportunityTableProps {
...
const WonOpportunityTable: React.FC<WonOpportunityTableProps> = ({
          ...
          <tbody>
            {data.map((item, idx) => (
              <tr key={idx} style={{ borderBottom: "1px solid #eee" }}>
                ...
                <td style={tdTope}>{formatDate(item.ReportDate)}</td>
...
const tdTope: React.CSSProperties = {
  padding: "8px",
  whiteSpace: "nowrap",
  fontSize: "14px",
...
export default WonOpportunityTable;